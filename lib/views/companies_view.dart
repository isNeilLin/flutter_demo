  ...
  Widget build(BuildContext context){
    return new Scaffold(
      ...
      appBar: new AppBar(
        elevation: 0.0,
        centerTitle: true,
        title: new Text('公司',style: new TextStyle(color: Colors.white),),
        ...
        actions: <Widget>[
          new IconButton(
            icon: new Icon(Icons.toys,color: Colors.white),
            onPressed: (){
              showDialog(
                context: context,
                child: new AlertDialog(
                  title: new Text('after title'),
                ),
              );
            },
            tooltip: 'today',
